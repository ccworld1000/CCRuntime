...
@interface CCObjCMethod : CCMethod
{
    Method _m;
}
...
@interface CCComponentsMethod : CCMethod
{
    SEL _sel;
    IMP _imp;
    NSString *_sig;
...
@implementation CCComponentsMethod
...
- (id)initWithObjCMethod: (Method)method
{
    return [[CCObjCMethod alloc] initWithObjCMethod: method];
}

- (id)initWithSelector: (SEL)sel implementation: (IMP)imp signature: (NSString *)signature
{
    return [[CCComponentsMethod alloc] initWithSelector: sel implementation: imp signature: signature];
}
...
{
    return [other isKindOfClass: [CCMethod class]] &&
